...
# lento y fácil; una velocidad alta lo hace más rápido y difícil. ---
    direccion_x = 1
    direccion_y = 1
    velocidad = 5     # La velocidad puede variar con una baja velocidad hace que 
...
while True:
    ...
    # El movimiento de la pelota, se actualizan X y Y al mismo tiempo
    # porque la pelota se mueve en diagonal, no en linea recta.
